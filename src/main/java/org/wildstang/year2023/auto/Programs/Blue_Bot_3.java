...
public class Blue_Bot_3 extends AutoProgram{
    ...
    protected void defineSteps(){
        ...
        group4.addStep(new SwervePathFollowerStep(PathPlanner.loadPath("Bot 3 B", new PathConstraints(2.0, 3.0)),
            swerve, color));
        ...
        group7.addStep(new SwervePathFollowerStep(PathPlanner.loadPath("Bot 3 D", new PathConstraints(2.0, 3.0)),
            swerve, color));
        AutoSerialStepGroup group7A = new AutoSerialStepGroup();
        group7A.addStep(new PathHeadingStep(color ? 150 : 210, swerve));
        group7A.addStep(new AutoStepDelay(1000));
