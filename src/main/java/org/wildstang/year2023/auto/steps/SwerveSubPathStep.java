...
public class SwerveSubPathStep extends AutoStep {
    ...
    /*litterally just SwervePathStep without the stop at the end*/
     ...
     *does not stop the robot. Only use if it is going to be followed immedietly by another path
     * @param pathData double[][] that contains path, should be from \frc\paths
     * @param drive the swerveDrive subsystem
     */
    public SwerveSubPathStep(PathPlannerTrajectory pathData, SwerveDriveTemplate drive) {
