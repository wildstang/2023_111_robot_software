...
public enum WSInputs implements Inputs {
    ...
    // ---------------------------------
    MANIPULATOR_LEFT_TRIGGER  ("Intake ingest",  new WsJSJoystickInputConfig(1, JoystickConstants.LEFT_TRIGGER)),
    MANIPULATOR_RIGHT_TRIGGER ("Intake expel", new WsJSJoystickInputConfig(1, JoystickConstants.RIGHT_TRIGGER)),
    ...
    LL_TXRIGHT("tx", new WsRemoteAnalogInputConfig("limelightRight")),
    LL_TYRIGHT("ty", new WsRemoteAnalogInputConfig("limelightRight")),
    LL_TVRIGHT("tv", new WsRemoteAnalogInputConfig("limelightRight")),
