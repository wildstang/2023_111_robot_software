...
public class ArmConstants{
    public static final double ARM_P_HOLDING = 0.1;
    public static final double ARM_I_HOLDING = 0;
    public static final double ARM_D_HOLDING = 0;
    public static final double ARM_P_EXTENDED = 0.1;
    ...
    public static final double LIFT_I_HOLDING = 0;
    public static final double LIFT_D_HOLDING = 0;
    public static final double LIFT_P_EXTENDED = 0.1;
    public static final double LIFT_I_EXTENDED = 0;
    public static final double LIFT_D_EXTENDED = 0;
    public static final int LIFT_CURRENT_LIMIT = 40;
